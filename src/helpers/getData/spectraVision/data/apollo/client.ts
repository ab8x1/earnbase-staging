...
import { BLOCKS_SUBGRAPH, PROTOCOL_SUBGRAPH, VISION_SPS_SUBGRAPH } from '../subgraph';
...
export const getProtocolClient = (chainId: ChainId) =>
  PROTOCOL_SUBGRAPH[chainId]
    ? clientFromURI(PROTOCOL_SUBGRAPH[chainId]?.url, undefined, PROTOCOL_SUBGRAPH[chainId]?.apiKey)
    : null;
